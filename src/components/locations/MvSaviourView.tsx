...
export default function MvSaviourView({ initialSubTab = 'VOYAGE_MONITORING' }: MvSaviourViewProps) {
  ...
  return (
    <div className="flex flex-col gap-6 w-full text-slate-100">
      ...
      {/* ==================================================================== */}
      {subTab === 'VOYAGE_MONITORING' && (
        <div className="grid grid-cols-[repeat(auto-fill,minmax(180px,1fr))] sm:grid-cols-[repeat(auto-fill,minmax(195px,1fr))] lg:grid-cols-[repeat(auto-fill,minmax(205px,1fr))] gap-3 animate-in fade-in duration-200">
          {filteredTanks.map((tank) => {
            ...
            return (
              <div
                ...
                className={`p-3.5 rounded-xl border cursor-pointer transition-all duration-200 flex flex-col justify-between group ${
                  isSelected
                    ? 'bg-cyan-950/40 border-cyan-500 shadow-md shadow-cyan-500/10 ring-1 ring-cyan-500/40'
              ...
              >
                <div>
                  ...
                  <div className="flex items-center gap-1 mb-2">
                    <span
                      className={`px-2 py-0.5 rounded text-[10px] font-semibold inline-flex items-center gap-1 border ${
                        isEmptyReturn
                ...
                <div className="mt-2.5 pt-1.5 border-t border-slate-800/40 flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="p-1 text-slate-500 hover:text-amber-400 rounded text-[10px] font-sans flex items-center gap-0.5"
                  >
