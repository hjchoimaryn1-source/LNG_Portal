      ...
      <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-4 sm:p-5 shadow-xl flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
        <div>
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <span className="text-xs font-mono text-cyan-300 bg-slate-950 px-2.5 py-0.5 rounded border border-slate-800 font-bold">
              PLN & PAG Monthly Custody Transfer Statement
            </span>
            <span className="inline-flex items-center gap-1.5 text-xs font-mono px-2.5 py-0.5 rounded border bg-emerald-950/80 text-emerald-300 border-emerald-500/40">
        ...
        <div className="flex items-center gap-2.5 flex-wrap self-start lg:self-center">
          {/* Month Selector */}
          <div className="flex items-center gap-1.5 bg-slate-950 px-3 py-1.5 rounded-xl border border-slate-800 font-mono text-xs text-slate-300">
          ...
          <button
            ...
            className={`px-3.5 py-1.5 rounded-xl border text-xs font-mono font-bold flex items-center gap-1.5 cursor-pointer transition-all ${
              isTrendOpen
                ? 'bg-cyan-600/30 text-cyan-300 border-cyan-500/50 shadow-md shadow-cyan-500/20'
        ...
        <div className="bg-slate-900/95 border border-cyan-500/40 rounded-3xl p-5 sm:p-6 shadow-2xl space-y-5 animate-in fade-in slide-in-from-top-3 duration-200">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 border-b border-slate-800 pb-3">
            ...
            <button
              ...
              className="text-xs font-mono text-slate-400 hover:text-white px-3 py-1 bg-slate-950 rounded-xl border border-slate-800 flex items-center gap-1 transition-colors cursor-pointer"
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4">
            ...
            <div className="p-4 bg-slate-950/90 rounded-2xl border border-slate-800 font-mono space-y-2">
              <div className="flex justify-between items-center text-xs">
                <span className="font-bold text-cyan-400">1. Total Flow Consumption (MSCF)</span>
                <span className="text-[10px] text-slate-500">Daily Gas Sendout</span>
              </div>
            ...
            <div className="p-4 bg-slate-950/90 rounded-2xl border border-slate-800 font-mono space-y-2">
              <div className="flex justify-between items-center text-xs">
                <span className="font-bold text-amber-400">2. Pressure Supply (Barg)</span>
                <span className="text-[10px] text-slate-500">Header Pressure</span>
              </div>
              <div className="h-52 w-full">
                <ResponsiveContainer width="100%" height="100%">
            ...
            <div className="p-4 bg-slate-950/90 rounded-2xl border border-slate-800 font-mono space-y-2">
              <div className="flex justify-between items-center text-xs">
                <span className="font-bold text-emerald-400">3. Total Energy (MMBTU)</span>
                <span className="text-[10px] text-slate-500">Daily Heat Transfer</span>
              </div>
              <div className="h-52 w-full">
                <ResponsiveContainer width="100%" height="100%">
            ...
            <div className="p-4 bg-slate-950/90 rounded-2xl border border-slate-800 font-mono space-y-2">
              <div className="flex justify-between items-center text-xs">
                <span className="font-bold text-blue-400">4. Total Stock LNG (m³ Liq)</span>
                <span className="text-[10px] text-slate-500">Onsite Terminal Stock</span>
              </div>
              <div className="h-52 w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={trendData} margin={{ top: 10, right: 10, left: -15, bottom: 0 }}>
            ...
            <div className="p-4 bg-slate-950/90 rounded-2xl border border-slate-800 font-mono space-y-2">
              <div className="flex justify-between items-center text-xs">
                <span className="font-bold text-purple-400">5. Laden vs Empty Tank Balance</span>
                <span className="text-[10px] text-slate-500">Daily 24-Tank Yard State</span>
              </div>
              <div className="h-52 w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={trendData} margin={{ top: 10, right: 10, left: -15, bottom: 0 }}>
            ...
            <div className="p-4 bg-slate-950/90 rounded-2xl border border-slate-800 font-mono space-y-2">
              <div className="flex justify-between items-center text-xs">
                <span className="font-bold text-rose-400">6. Total Energy Accumulative (MMBTU)</span>
                <span className="text-[10px] text-slate-500">Monthly Accumulated Total</span>
              </div>
              <div className="h-52 w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={trendData} margin={{ top: 10, right: 10, left: -15, bottom: 0 }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 font-mono text-xs">
          ...
          <div className="p-4 bg-slate-900/90 rounded-2xl border border-cyan-500/30 shadow-lg space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2.5">
              <div className="p-2.5 bg-slate-950 rounded-xl border border-slate-800/80">
                <span className="text-[10px] text-slate-400 block mb-0.5">Totalizer Flow</span>
                <span className="text-base font-black text-cyan-300 block">14,820.5 MSCF</span>
                <span className="text-[9px] text-slate-500 block">Cum: 246.3 MMSCF</span>
              </div>
              <div className="p-2.5 bg-slate-950 rounded-xl border border-slate-800/80">
                <span className="text-[10px] text-slate-400 block mb-0.5">Energy Flow</span>
                <span className="text-base font-black text-emerald-400 block">15,539.4 MMBTU</span>
                <span className="text-[9px] text-slate-500 block">Cum: 258,240 MMBTU</span>
              </div>
            </div>
            ...
            <div className="p-2.5 bg-slate-950 rounded-xl border border-slate-800/80 space-y-1.5 text-[11px]">
              <div className="flex justify-between text-slate-400">
                ...
                <span className="text-slate-200 font-bold">2.18 Barg</span>
              </div>
              <div className="flex justify-between text-slate-400">
              ...
              <div className="flex justify-between text-slate-400">
                ...
                <span className="text-slate-200 font-bold">2.18 kg/m³</span>
              </div>
              <div className="flex justify-between text-slate-400">
                <span>GHV / Heating Value:</span>
                <span className="text-amber-400 font-bold">1,048.5 BTU/SCF</span>
              </div>
              <div className="flex justify-between text-slate-400">
                <span>Differential Pressure:</span>
                <span className="text-cyan-300 font-bold">14.2 inH2O</span>
              </div>
            </div>
          </div>
          ...
          <div className="p-4 bg-slate-900/90 rounded-2xl border border-slate-800 shadow-lg space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2.5">
              <div className="p-2.5 bg-slate-950 rounded-xl border border-slate-800/80">
                <span className="text-[10px] text-slate-400 block mb-0.5">Totalizer Flow</span>
                <span className="text-base font-black text-slate-300 block">14,815.2 MSCF</span>
                <span className="text-[9px] text-slate-500 block">Delta: -0.04%</span>
              </div>
              <div className="p-2.5 bg-slate-950 rounded-xl border border-slate-800/80">
                <span className="text-[10px] text-slate-400 block mb-0.5">Energy Flow</span>
                <span className="text-base font-black text-emerald-400 block">15,533.8 MMBTU</span>
                <span className="text-[9px] text-slate-500 block">Delta: -5.6 MMBTU</span>
              </div>
            </div>
            ...
            <div className="p-2.5 bg-slate-950 rounded-xl border border-slate-800/80 space-y-1.5 text-[11px]">
              <div className="flex justify-between text-slate-400">
                <span>Supply Pressure:</span>
                <span className="text-slate-200 font-bold">2.16 Barg</span>
              </div>
              <div className="flex justify-between text-slate-400">
                <span>Gas Temperature:</span>
                <span className="text-slate-200 font-bold">24.2 °C</span>
              </div>
              <div className="flex justify-between text-slate-400">
                <span>Gas Density:</span>
                <span className="text-slate-200 font-bold">2.18 kg/m³</span>
              ...
              <div className="flex justify-between text-slate-400">
                <span>Differential Pressure:</span>
                <span className="text-cyan-300 font-bold">13.8 inH2O</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 bg-slate-900/90 rounded-2xl border border-slate-800 shadow-lg space-y-3 flex flex-col justify-between">
          <div>
            <div className="flex justify-between items-center border-b border-slate-800 pb-2 mb-3">
              ...
              <span className="text-[10px] text-slate-400">Monthly Net Batch</span>
            </div>

            <div className="space-y-2.5">
              <div className="p-3 bg-slate-950 rounded-xl border border-slate-800/80 flex justify-between items-center">
                <span className="text-slate-400">ISO Tanks Offloaded in Month:</span>
                <span className="text-emerald-300 font-bold text-sm">28 Tanks</span>
              </div>
              <div className="p-3 bg-slate-950 rounded-xl border border-slate-800/80 flex justify-between items-center">
                <span className="text-slate-400">Total Liquid Vaporized:</span>
                <span className="text-slate-200 font-bold text-sm">1,153.6 m³ Liq (≈ 29,226 MSCF)</span>
              </div>
              <div className="p-3 bg-slate-950 rounded-xl border border-slate-800/80 flex justify-between items-center">
                <span className="text-slate-400">Avg Offload Pressure & Temp:</span>
                <span className="text-cyan-300 font-bold text-sm">0.76 MPa | -156.4 °C</span>
              </div>
              <div className="p-3 bg-slate-950 rounded-xl border border-slate-800/80 flex justify-between items-center">
                <span className="text-slate-400">PLTMG Custody Energy Received:</span>
                <span className="text-amber-400 font-black text-sm">{monthlyMetrics.totalEnergyMmbtu.toLocaleString()} MMBTU</span>
              </div>
            </div>
          </div>
          ...
          <div className="pt-2 border-t border-slate-800/80 flex justify-between items-center text-[10px] text-slate-400">
            ...
            <span className="text-emerald-400 font-bold">98.50% (Line Loss: 1.50%)</span>
          </div>
        </div>
        ...
        <div className="p-4 bg-slate-900/90 rounded-2xl border border-amber-500/30 shadow-lg space-y-3 flex flex-col justify-between">
          <div>
            <div className="flex justify-between items-center border-b border-slate-800 pb-2 mb-3">
              ...
              <span className="text-[10px] text-slate-400">Rate: ${unitPriceUSD.toFixed(2)}/MMBTU</span>
            </div>

            <div className="space-y-2.5">
              <div className="p-3 bg-slate-950 rounded-xl border border-slate-800/80 flex justify-between items-center">
                <span className="text-slate-400">Gross Invoiced Heat (PAG):</span>
                <span className="text-amber-400 font-black text-sm">
                  ${monthlyMetrics.totalInvoicedUSD.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })} USD
                </span>
              </div>
              <div className="p-3 bg-slate-950 rounded-xl border border-slate-800/80 flex justify-between items-center">
                <span className="text-slate-400">Accepted Heat Payment (PLN):</span>
                <span className="text-emerald-400 font-black text-sm">
                  ${monthlyMetrics.acceptedAmountUSD.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })} USD
                </span>
              </div>
              <div className="p-3 bg-slate-950 rounded-xl border border-slate-800/80 flex justify-between items-center">
                <span className="text-slate-400">Variance & Reconciliation Gap:</span>
              ...
              <div className="p-3 bg-slate-950 rounded-xl border border-slate-800/80 flex justify-between items-center">
                <span className="text-slate-400">Audit Status / Penalty Flag:</span>
          ...
          <div className="pt-2 border-t border-slate-800/80 flex justify-between items-center text-[10px] text-slate-400">
            ...
            <span className="text-slate-200 font-bold">Monthly Calendar Cut-off (24:00 WIB)</span>
          </div>
        </div>
      </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-slate-950 text-slate-400 border-b border-slate-800 text-[10px] uppercase font-bold tracking-wider">
                ...
                <th className="px-3 py-3 text-center text-slate-200">Total Tanks</th>
                <th className="px-3 py-3 text-right text-cyan-300">Stock (m³ Liq)</th>
                <th className="px-3 py-3 text-right text-emerald-400 font-bold">Stock (MSCF)</th>
            ...
            <tbody className="divide-y divide-slate-800/60 text-slate-300">
              ...
              <tr className="hover:bg-slate-800/40">
                ...
                <td className="px-3 py-3 text-center font-bold text-emerald-400">{stockInventory.onsite.laden}</td>
                <td className="px-3 py-3 text-center text-slate-400">{stockInventory.onsite.empty}</td>
                <td className="px-3 py-3 text-center font-bold text-slate-200">{stockInventory.onsite.total}</td>
                <td className="px-3 py-3 text-right text-cyan-300 font-bold">{stockInventory.onsite.volM3.toFixed(1)} m³</td>
                <td className="px-3 py-3 text-right text-emerald-400 font-black">{stockInventory.onsite.mscf.toLocaleString()}</td>
                <td className="px-3 py-3 text-right text-slate-300">{stockInventory.onsite.press.toFixed(2)}</td>
                <td className="px-3 py-3 text-right text-slate-300">{stockInventory.onsite.temp.toFixed(1)}</td>
              ...
              <tr className="hover:bg-slate-800/40">
                ...
                <td className="px-3 py-3 text-center font-bold text-blue-400">{stockInventory.ship.laden}</td>
                <td className="px-3 py-3 text-center text-slate-400">{stockInventory.ship.empty}</td>
                <td className="px-3 py-3 text-center font-bold text-slate-200">{stockInventory.ship.total}</td>
                <td className="px-3 py-3 text-right text-cyan-300 font-bold">{stockInventory.ship.volM3.toFixed(1)} m³</td>
                <td className="px-3 py-3 text-right text-emerald-400 font-black">{stockInventory.ship.mscf.toLocaleString()}</td>
                <td className="px-3 py-3 text-right text-slate-300">{stockInventory.ship.press.toFixed(2)}</td>
                <td className="px-3 py-3 text-right text-slate-300">{stockInventory.ship.temp.toFixed(1)}</td>
                <td className="px-4 py-3 text-center">
              ...
              <tr className="hover:bg-slate-800/40">
                ...
                <td className="px-3 py-3 text-center font-bold text-amber-400">{stockInventory.arun.laden}</td>
                <td className="px-3 py-3 text-center text-slate-400">{stockInventory.arun.empty}</td>
                <td className="px-3 py-3 text-center font-bold text-slate-200">{stockInventory.arun.total}</td>
                <td className="px-3 py-3 text-right text-cyan-300 font-bold">{stockInventory.arun.volM3.toFixed(1)} m³</td>
                <td className="px-3 py-3 text-right text-emerald-400 font-black">{stockInventory.arun.mscf.toLocaleString()}</td>
                <td className="px-3 py-3 text-right text-slate-300">{stockInventory.arun.press.toFixed(2)}</td>
                <td className="px-3 py-3 text-right text-slate-300">{stockInventory.arun.temp.toFixed(1)}</td>
                <td className="px-4 py-3 text-center">
              ...
              <tr className="bg-slate-950/90 font-bold border-t-2 border-slate-700">
                <td className="px-4 py-3 text-amber-400">Total 120 Fleet Distribution:</td>
                ...
                <td className="px-3 py-3 text-right text-cyan-300 font-black">{stockInventory.totalFleetVolM3.toFixed(1)} m³</td>
                <td className="px-3 py-3 text-right text-emerald-300 font-black">{stockInventory.totalFleetMscf.toLocaleString()} MSCF</td>
                <td className="px-3 py-3 text-right text-slate-400">-</td>
                <td className="px-3 py-3 text-right text-slate-400">-</td>
                <td className="px-4 py-3 text-center text-emerald-400">100% RECONCILED</td>
              </tr>
            </tbody>
          </table>
        </div>
