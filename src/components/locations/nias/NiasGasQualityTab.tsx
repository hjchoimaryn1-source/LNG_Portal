...
export default function NiasGasQualityTab() {
  ...
  return (
    <div className="w-full space-y-4 animate-in fade-in duration-200 text-slate-100 font-sans">
      ...
      <div className="w-full flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 bg-slate-900/90 border border-slate-800 rounded-2xl p-4 shadow-xl">
        ...
        <div className="flex items-center gap-2.5 flex-wrap">
          <button
            ...
            className="flex items-center gap-1.5 px-3.5 py-2 bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl text-xs font-semibold shadow-md shadow-emerald-500/20 transition-all cursor-pointer"
          >
          ...
          {filterMode === 'DATE_RANGE' ? (
            <div className="flex items-center gap-1.5 animate-in fade-in duration-150">
              <label className="relative flex items-center gap-1.5 bg-slate-950 hover:bg-slate-900 border border-slate-800 hover:border-cyan-500/60 px-2.5 py-1.5 rounded-xl cursor-pointer transition-all shadow-inner group">
                ...
                <span className="text-cyan-300 font-bold text-xs">{rangeStartDate}</span>
                <Calendar className="w-3 h-3 text-cyan-400 group-hover:scale-110 transition-transform ml-0.5" />
                <input
                  type="date"
              ...
              <label className="relative flex items-center gap-1.5 bg-slate-950 hover:bg-slate-900 border border-slate-800 hover:border-cyan-500/60 px-2.5 py-1.5 rounded-xl cursor-pointer transition-all shadow-inner group">
                ...
                <span className="text-cyan-300 font-bold text-xs">{rangeEndDate}</span>
                <Calendar className="w-3 h-3 text-cyan-400 group-hover:scale-110 transition-transform ml-0.5" />
                <input
                  type="date"
                  value={rangeEndDate}
            ...
            <div className="flex items-center gap-2 animate-in fade-in duration-150">
              <div className="flex items-center gap-1 bg-slate-950 px-2.5 py-1.5 rounded-xl border border-slate-800">
                <span className="text-slate-500 text-[10px]">연도:</span>
                <select
                  value={selectedYear}
                  onChange={(e) => setSelectedYear(e.target.value)}
                  className="bg-transparent text-amber-300 font-bold focus:outline-none cursor-pointer text-xs"
                >
                  <option value="2026" className="bg-slate-900 text-slate-200">2026년</option>
                  <option value="2025" className="bg-slate-900 text-slate-200">2025년</option>
                </select>
              </div>

              <div className="flex items-center gap-1 bg-slate-950 px-2.5 py-1.5 rounded-xl border border-slate-800">
                <span className="text-slate-500 text-[10px]">월:</span>
                <select
                  value={selectedMonth}
        ...
        <div className="flex items-center gap-2.5 flex-wrap">
          <div className="flex items-center gap-2 bg-slate-950 px-3 py-1.5 rounded-xl border border-slate-800 text-xs font-mono">
            ...
            <input
              ...
              className="bg-transparent text-slate-200 placeholder-slate-500 focus:outline-none text-xs w-32 sm:w-44"
            />
          </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
        ...
        <div className="p-3.5 bg-slate-900/90 rounded-2xl border border-amber-500/30 shadow-md font-mono flex flex-col justify-between">
          ...
          <span className="text-[10px] text-slate-400 mt-1">
            MMBTU <span className="text-slate-500 font-normal">(Station Total)</span>
          </span>
        </div>
        ...
        <div className="p-3.5 bg-slate-900/90 rounded-2xl border border-slate-800 shadow-md font-mono flex flex-col justify-between">
          <div>
            ...
            <span className="text-lg sm:text-xl font-black text-slate-100 block mt-1">
              {summaryMetrics.totalVolMscf.toFixed(2)}
            </span>
          </div>
          <span className="text-[10px] text-slate-400 mt-1">
            MMCF <span className="text-slate-500 font-normal">(Station CVOL)</span>
          </span>
        </div>
        ...
        <div className="p-3.5 bg-slate-900/90 rounded-2xl border border-emerald-500/30 shadow-md font-mono flex flex-col justify-between">
          ...
          <span className="text-[10px] text-slate-400 mt-1">
            Tonne <span className="text-slate-500 font-normal">(≈ {(summaryMetrics.totalMassTonne * 1000).toLocaleString()} kg)</span>
          </span>
        </div>
        ...
        <div className="p-3.5 bg-slate-900/90 rounded-2xl border border-cyan-500/30 shadow-md font-mono flex flex-col justify-between">
          ...
          <span className="text-[10px] text-slate-400 mt-1">
            BTU/Scf <span className="text-slate-500 font-normal">(Custody Heat)</span>
          </span>
        </div>
        ...
        <div className="p-3.5 bg-slate-900/90 rounded-2xl border border-slate-800 shadow-md font-mono flex flex-col justify-between">
          ...
          <span className="text-[10px] text-slate-400 mt-1">
            Mol % <span className="text-slate-500 font-normal">(Primary Spec)</span>
          </span>
        </div>
        ...
        <div className="p-3.5 bg-slate-900/90 rounded-2xl border border-slate-800 shadow-md font-mono flex flex-col justify-between">
          <div>
            ...
            <span className="text-lg sm:text-xl font-black text-blue-400 block mt-1">
              {summaryMetrics.recordCount} Days
            </span>
          </div>
          <span className="text-[10px] text-emerald-400 mt-1 truncate">
            {primaryActiveTank.tankNo} <span className="text-slate-500 font-normal">(@ Bay {primaryActiveTank.bayTag})</span>
          </span>
        </div>
      </div>
      ...
      >
        ...
        <div className="p-3.5 sm:p-4 bg-slate-950/60 border-b border-slate-800/80 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-3">
          <div className="flex items-center gap-3 flex-wrap">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  {isFormExpanded ? (
                    ...
                    <ChevronDown className="w-4 h-4 text-slate-400 group-hover:text-emerald-400 transition-transform" />
                  )}
                </div>
            ...
            <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-xl text-xs font-mono font-bold bg-emerald-950/80 text-emerald-300 border border-emerald-500/40 shadow-sm ml-0 lg:ml-2">
              <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
              <span>
                🟢 Active Discharge Feed: <strong className="text-white">{primaryActiveTank.tankNo}</strong> ({primaryActiveTank.serialNo}) @ Bay <strong className="text-cyan-300">{primaryActiveTank.bayTag}</strong>
              </span>
            </span>
          </div>
          ...
          <div className="flex items-center gap-2 flex-wrap self-start lg:self-center">
            ...
            <label className="relative flex items-center gap-2 bg-slate-950 hover:bg-slate-900 border border-slate-700 hover:border-emerald-500 px-3 py-1.5 rounded-xl cursor-pointer transition-all shadow-inner group">
              ...
              <span className="text-emerald-300 font-mono font-black text-xs tracking-wide">
                {entryDate}
              </span>
            ...
            <button
              ...
              className="px-2.5 py-1.5 bg-slate-950 hover:bg-slate-900 text-slate-300 rounded-xl border border-slate-800 text-xs font-semibold flex items-center gap-1 transition-colors cursor-pointer"
            >
        ...
        {isFormExpanded && (
          <div className="p-4 sm:p-5 space-y-5 animate-in fade-in slide-in-from-top-2 duration-200">
            ...
            <div className="space-y-2">
              ...
              <div className="overflow-x-auto rounded-xl border border-slate-800 bg-slate-950/80">
                <table className="w-full text-xs text-left border-collapse font-mono">
                  <thead>
                    {/* 1st Tier Header */}
                    <tr className="bg-emerald-950/40 text-emerald-300 border-b border-slate-800 text-[10px] uppercase font-bold text-center">
                      ...
                      <th colSpan={4} className="px-3 py-1.5 bg-amber-950/30 text-amber-300">
                        STATION (Total)
                      </th>
                    </tr>
                    {/* 2nd Tier Header */}
                    <tr className="bg-slate-900/90 text-slate-400 border-b border-slate-800 text-[9px] uppercase font-semibold text-center">
                      {/* M-101A */}
                      <th className="px-2 py-1.5">UVOL (MMCF)</th>
                      <th className="px-2 py-1.5">CVOL (MMCF)</th>
                      <th className="px-2 py-1.5">(Tonne)</th>
                      <th className="px-2 py-1.5 border-r border-slate-800 text-amber-400">(MMBTU)</th>
                      {/* M-101B */}
                      <th className="px-2 py-1.5">UVOL (MMCF)</th>
                      <th className="px-2 py-1.5">CVOL (MMCF)</th>
                      <th className="px-2 py-1.5">(Tonne)</th>
                      ...
                      <th className="px-2 py-1.5">UVOL (MMCF)</th>
                      <th className="px-2 py-1.5">CVOL (MMCF)</th>
                      <th className="px-2 py-1.5 text-emerald-400">(Tonne)</th>
                      <th className="px-2 py-1.5 text-amber-400 font-bold">(MMBTU)</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr className="bg-slate-950">
                      ...
                      <td className="p-1.5">
                        <input
                          ...
                          className="w-full bg-slate-900 text-slate-200 px-1.5 py-1 rounded border border-slate-800 text-right focus:outline-none focus:border-emerald-500 text-xs"
                        />
                      </td>
                      <td className="p-1.5">
                        <input
                      ...
                      <td className="p-1.5 border-r border-slate-800">
                        <input
                          ...
                          className="w-full bg-slate-900 text-amber-400 px-1.5 py-1 rounded border border-slate-800 text-right focus:outline-none focus:border-amber-500 text-xs font-bold"
                        />
                      </td>
                      ...
                      <td className="p-1.5">
                        <input
                          ...
                          className="w-full bg-slate-900 text-slate-200 px-1.5 py-1 rounded border border-slate-800 text-right focus:outline-none focus:border-emerald-500 text-xs font-bold"
                        />
                      </td>
                      <td className="p-1.5">
                        <input
                      ...
                      <td className="p-1.5">
                        <input
                          ...
                          className="w-full bg-slate-900 text-emerald-400 px-1.5 py-1 rounded border border-slate-800 text-right focus:outline-none focus:border-emerald-500 text-xs font-bold"
                        />
                      </td>
                      <td className="p-1.5">
                        <input
                          ...
                          className="w-full bg-slate-900 text-amber-400 px-1.5 py-1 rounded border border-slate-800 text-right focus:outline-none focus:border-amber-500 text-xs font-black"
                        />
                      </td>
                    </tr>
                  </tbody>
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                <span className="px-2 py-0.5 rounded bg-cyan-500/20 text-cyan-300 text-[10px] font-bold font-mono border border-cyan-500/30">
                  SECTION 2
                </span>
                <h5 className="text-xs font-bold text-slate-200 flex items-center gap-1.5">
              ...
              <div className="overflow-x-auto rounded-xl border border-slate-800 bg-slate-950/80">
                <table className="w-full text-xs text-left border-collapse font-mono">
                  <thead>
                    {/* 1st Tier Header */}
                    <tr className="bg-cyan-950/40 text-cyan-300 border-b border-slate-800 text-[10px] uppercase font-bold text-center">
                      <th colSpan={4} className="px-3 py-1.5 border-r border-slate-800">
                        M-101A (Run 1)
                      </th>
                      <th colSpan={4} className="px-3 py-1.5 border-r border-slate-800">
                    ...
                    <tr className="bg-slate-950">
                      ...
                      <td className="p-1.5">
                        <input
                          ...
                          className="w-full bg-slate-900 text-slate-200 px-1.5 py-1 rounded border border-slate-800 text-right focus:outline-none focus:border-cyan-500 text-xs"
                        />
                      </td>
                      <td className="p-1.5">
                        <input
                          ...
                          className="w-full bg-slate-900 text-slate-200 px-1.5 py-1 rounded border border-slate-800 text-right focus:outline-none focus:border-cyan-500 text-xs font-bold"
                        />
                      </td>
                      <td className="p-1.5">
                        <input
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                <span className="px-2 py-0.5 rounded bg-indigo-500/20 text-indigo-300 text-[10px] font-bold font-mono border border-indigo-500/30">
                  SECTION 3
                </span>
                <h5 className="text-xs font-bold text-slate-200 flex items-center gap-1.5">
              ...
              <div className="overflow-x-auto rounded-xl border border-slate-800 bg-slate-950/80">
                <table className="w-full text-xs text-left border-collapse font-mono">
                  <thead>
                    {/* 1st Tier Header */}
                    <tr className="bg-indigo-950/40 text-indigo-300 border-b border-slate-800 text-[10px] uppercase font-bold text-center">
                    ...
                    <tr className="bg-slate-900/90 text-slate-400 border-b border-slate-800 text-[9px] uppercase font-semibold text-center">
                      ...
                      <th className="px-2 py-1.5 border-r border-slate-800 text-amber-400 font-bold">GHV (BTU/SCF)</th>
                      {/* M-101 B */}
                      <th className="px-2 py-1.5">Press (Barg)</th>
                      <th className="px-2 py-1.5">Temp (℃)</th>
                      <th className="px-2 py-1.5">Line Dens (kg/㎥)</th>
                      <th className="px-2 py-1.5">Line Compress (Zf)</th>
                      <th className="px-2 py-1.5 text-amber-400 font-bold">GHV (BTU/SCF)</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr className="bg-slate-950">
                      ...
                      <td className="p-1.5">
                        <input
                          ...
                          className="w-full bg-slate-900 text-slate-200 px-1.5 py-1 rounded border border-slate-800 text-right focus:outline-none focus:border-indigo-500 text-xs font-bold"
                        />
                      </td>
                      <td className="p-1.5">
                        <input
                      ...
                      <td className="p-1.5">
                        <input
                          ...
                          className="w-full bg-slate-900 text-slate-200 px-1.5 py-1 rounded border border-slate-800 text-right focus:outline-none focus:border-indigo-500 text-xs"
                        />
                      </td>
                      <td className="p-1.5">
                        <input
                      ...
                      <td className="p-1.5 border-r border-slate-800">
                        <input
                          ...
                          className="w-full bg-slate-900 text-emerald-400 px-1.5 py-1 rounded border border-slate-800 text-right focus:outline-none focus:border-emerald-500 text-xs font-black"
                        />
                      </td>
            ...
            <div className="space-y-2">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
                <div className="flex items-center gap-2">
                  <span className="px-2 py-0.5 rounded bg-purple-500/20 text-purple-300 text-[10px] font-bold font-mono border border-purple-500/30">
                    SECTION 4
                  </span>
                  <h5 className="text-xs font-bold text-slate-200 flex items-center gap-1.5">
              ...
              <div className="overflow-x-auto rounded-xl border border-slate-800 bg-slate-950/80">
                <table className="w-full text-xs text-left border-collapse font-mono">
                  <thead>
                    <tr className="bg-purple-950/40 text-purple-300 border-b border-slate-800 text-[9px] uppercase font-bold text-center">
                      <th className="px-3 py-1.5 text-left border-r border-slate-800 min-w-[260px]">
                        Stream / Measurement Node
                      </th>
                      <th className="px-2 py-1.5 text-cyan-300">CH₄ (%)</th>
                      ...
                      <th className="px-2.5 py-1.5 bg-emerald-950/30 text-emerald-300 font-black">
                        Total (%)
                      </th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-slate-800/60 text-slate-300">
                    ...
                    <tr className="bg-slate-950 hover:bg-slate-900/50">
                      <td className="px-3 py-1.5 border-r border-slate-800 text-left font-bold text-emerald-300 flex items-center justify-between gap-1.5">
                        <div className="flex items-center gap-1.5">
                          <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
                          <span>Feed Tank: <strong className="text-white">{primaryActiveTank.tankNo}</strong></span>
                        </div>
                        <span className="text-[9px] text-emerald-400 font-mono font-semibold bg-emerald-950/80 px-1.5 py-0.5 rounded border border-emerald-500/30">
                          Arun COQ Linked
                        </span>
                      </td>
                      <td className="p-1">
                        <input
                          ...
                          className="w-full bg-slate-900 text-emerald-400 px-1.5 py-0.5 rounded border border-slate-800 text-right text-xs font-bold"
                        />
                      </td>
                      <td className="px-2 py-1 text-right text-slate-300">{gcActiveTank.c2h6.toFixed(4)}</td>
                      <td className="px-2 py-1 text-right text-slate-300">{gcActiveTank.c3h8.toFixed(4)}</td>
                      <td className="px-2 py-1 text-right text-slate-400">{gcActiveTank.iC4.toFixed(4)}</td>
                      <td className="px-2 py-1 text-right text-slate-400">{gcActiveTank.nC4.toFixed(4)}</td>
                      <td className="px-2 py-1 text-right text-slate-400">{gcActiveTank.iC5.toFixed(4)}</td>
                      <td className="px-2 py-1 text-right text-slate-400">{gcActiveTank.nC5.toFixed(4)}</td>
                      <td className="px-2 py-1 text-right text-slate-400">{gcActiveTank.n2.toFixed(4)}</td>
                      <td className="px-2 py-1 text-right text-slate-400 border-r border-slate-800">{gcActiveTank.co2.toFixed(4)}</td>
                      <td className="px-2.5 py-1 text-right text-emerald-400 font-black bg-emerald-950/20">
                        100.00 %
                      </td>
                    </tr>
                    ...
                    <tr className="bg-slate-950 hover:bg-slate-900/50">
                      <td className="px-3 py-1.5 border-r border-slate-800 text-left font-bold text-cyan-300 flex items-center gap-1.5">
                        <Gauge className="w-3.5 h-3.5 text-cyan-400" />
                        <span>Discharge Header M-101 A</span>
                        <span className="text-[10px] text-cyan-400/80 bg-cyan-950/60 px-1.5 py-0.2 rounded border border-cyan-500/20 font-normal">
                          Custody
                        </span>
                      </td>
                      <td className="p-1">
                        <input
                          ...
                          className="w-full bg-slate-900 text-cyan-300 px-1.5 py-0.5 rounded border border-slate-800 text-right text-xs font-bold"
                        />
                      </td>
                      <td className="p-1">
                        <input
                          ...
                          className="w-full bg-slate-900 text-slate-200 px-1.5 py-0.5 rounded border border-slate-800 text-right text-xs"
                        />
                      </td>
                      <td className="p-1">
                        <input
                      ...
                      <td className="px-2.5 py-1 text-right text-cyan-300 font-black bg-cyan-950/20">
                    ...
                    <tr className="bg-slate-950 hover:bg-slate-900/50">
                      <td className="px-3 py-1.5 border-r border-slate-800 text-left font-bold text-indigo-300 flex items-center gap-1.5">
                        <Gauge className="w-3.5 h-3.5 text-indigo-400" />
                        <span>Discharge Header M-101 B</span>
                        <span className="text-[10px] text-indigo-400/80 bg-indigo-950/60 px-1.5 py-0.2 rounded border border-indigo-500/20 font-normal">
                          Redundant
                        </span>
                      </td>
                      <td className="p-1">
                        <input
                          ...
                          className="w-full bg-slate-900 text-indigo-300 px-1.5 py-0.5 rounded border border-slate-800 text-right text-xs font-bold"
                        />
                      </td>
                      <td className="p-1">
                        <input
                      ...
                      <td className="px-2.5 py-1 text-right text-indigo-300 font-black bg-indigo-950/20">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center gap-3 pt-2">
              {toastMessage ? (
                <div className="p-2.5 bg-emerald-500/15 border border-emerald-500/30 rounded-xl text-xs font-mono text-emerald-400 flex items-center gap-2 animate-in fade-in duration-150">
              ...
              <div className="flex items-center gap-2.5 w-full sm:w-auto">
                <button
                  ...
                  onClick={() => populateFormFromDate(entryDate)}
                  title="Reset Form from Stored Date Values"
                  className="px-3.5 py-2 bg-slate-950 hover:bg-slate-900 text-slate-300 rounded-xl border border-slate-800 text-xs font-semibold flex items-center gap-1.5 transition-colors cursor-pointer"
                >
                  <RotateCcw className="w-3.5 h-3.5" />
      ...
      <div className="bg-slate-900/90 border border-slate-800 rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="overflow-x-auto max-h-[620px] scrollbar-thin scrollbar-thumb-slate-700">
          <table className="w-full text-xs text-left border-collapse font-mono">
            ...
            <thead className="bg-slate-950 text-slate-300 sticky top-0 z-30 shadow-md">
              {/* Tier 1 Group Headers */}
              <tr className="border-b border-slate-800 text-[10px] uppercase font-bold tracking-wider">
                <th className="px-3 py-2 bg-slate-950 sticky left-0 z-40 border-r border-slate-800 text-cyan-400 text-left">
                  DATE
                </th>
                <th colSpan={5} className="px-3 py-2 bg-amber-950/40 text-amber-300 border-r border-slate-800 text-center">
                  STATION
                </th>
                <th colSpan={7} className="px-3 py-2 bg-cyan-950/40 text-cyan-300 border-r border-slate-800 text-center">
                  METER RUN A (M-101A)
                </th>
                <th colSpan={7} className="px-3 py-2 bg-indigo-950/40 text-indigo-300 border-r border-slate-800 text-center">
                  METER RUN B (M-101B)
                </th>
                <th colSpan={7} className="px-3 py-2 bg-emerald-950/40 text-emerald-300 border-r border-slate-800 text-center">
                  GC MOLECULAR COMPOSITION (% MOL)
                </th>
                {showHeavyTrace && (
                  <th colSpan={9} className="px-3 py-2 bg-purple-950/40 text-purple-300 text-center">
              ...
              <tr className="border-b border-slate-800 text-[9px] uppercase font-semibold text-slate-400 bg-slate-950/90">
                {/* Single Frozen Date Column */}
                <th className="px-3 py-2 sticky left-0 z-40 bg-slate-950 min-w-[105px] text-cyan-400 border-r border-slate-800 text-left">
                  DATE
                </th>
                ...
                <th className="px-2.5 py-2 text-right text-emerald-400">TONNE</th>
                <th className="px-2.5 py-2 text-right text-amber-400 font-bold">MMBTU</th>
                <th className="px-2.5 py-2 text-right border-r border-slate-800 text-slate-400">CUM. MMBTU</th>
                ...
                <th className="px-2.5 py-2 text-right text-amber-400">MMBTU</th>
                ...
                <th className="px-2.5 py-2 text-right text-cyan-400">CH₄ [%]</th>
                ...
                {showHeavyTrace && (
                  <>
                    ...
                    <th className="px-2 py-2 text-right">C₉ [%]</th>
                    <th className="px-2 py-2 text-right">C₁₀ [%]</th>
                    <th className="px-2 py-2 text-right text-emerald-400">H₂S [%]</th>
                    <th className="px-2 py-2 text-right text-emerald-400">H₂O [%]</th>
                  </>
                )}
              </tr>
            </thead>
              ...
              {filteredRecords.length > 0 ? (
                filteredRecords.map((row, idx) => {
                  ...
                  return (
                    ...
                    >
                      {/* Single Frozen Date Column */}
                      <td className="px-3 py-2.5 sticky left-0 z-20 bg-slate-950 font-bold text-cyan-300 border-r border-slate-800/80">
                        {row.date}
                      </td>

                      {/* Station Deliveries: UVOL, CVOL, TONNE, MMBTU, CUM. MMBTU */}
                      <td className="px-2.5 py-2.5 text-right text-slate-200">
                        {row.dailyStation.uvol > 0 ? row.dailyStation.uvol.toFixed(2) : '-'}
                      </td>
                      <td className="px-2.5 py-2.5 text-right text-slate-200">
                        {row.dailyStation.cvol > 0 ? row.dailyStation.cvol.toFixed(2) : '-'}
                      </td>
                      <td className="px-2.5 py-2.5 text-right font-bold text-emerald-400">
                        {row.dailyStation.massTonne > 0 ? row.dailyStation.massTonne.toFixed(2) : '-'}
                      </td>
                      <td className="px-2.5 py-2.5 text-right font-bold text-amber-400">
                      ...
                      <td className="px-2.5 py-2.5 text-right text-slate-400 border-r border-slate-800/80">
                      ...
                      {/* Key GC Fractions */}
                      <td className="px-2.5 py-2.5 text-right text-cyan-400 font-bold">
                ...
                <tr>
                  <td
                    ...
                    className="px-4 py-8 text-center text-slate-500 font-mono"
                  >
            ...
            <tfoot className="bg-slate-950 text-slate-200 border-t-2 border-slate-800 font-bold sticky bottom-0 z-20 shadow-lg">
              <tr>
                <td className="px-3 py-3 sticky left-0 z-30 bg-slate-950 text-cyan-400 uppercase text-[10px] border-r border-slate-800">
                  Summary Totals
                </td>

                {/* Station Totals Sum: UVOL, CVOL, TONNE, MMBTU, CUM. MMBTU */}
                <td className="px-2.5 py-3 text-right text-slate-200">
                  {filteredRecords.reduce((a, b) => a + b.dailyStation.uvol, 0).toFixed(2)}
                </td>
                <td className="px-2.5 py-3 text-right text-slate-200">
                  {summaryMetrics.totalVolMscf.toFixed(2)}
                </td>
                <td className="px-2.5 py-3 text-right text-emerald-400 text-sm">
                  {summaryMetrics.totalMassTonne.toFixed(2)}
                </td>
                <td className="px-2.5 py-3 text-right text-amber-400 text-sm">
                  {summaryMetrics.totalEnergy.toLocaleString(undefined, {
                    minimumFractionDigits: 1,
                    maximumFractionDigits: 1,
                  })}
                </td>
                <td className="px-2.5 py-3 text-right text-slate-500 border-r border-slate-800">-</td>

                {/* Meter A Sum */}
                <td className="px-2.5 py-3 text-right text-slate-400">
                ...
                <td className="px-2.5 py-3 text-right text-slate-500">-</td>
                <td className="px-2.5 py-3 text-right text-slate-500">-</td>
                <td className="px-2.5 py-3 text-right text-slate-500 border-r border-slate-800">-</td>
                ...
                {/* GC Averages */}
                <td className="px-2.5 py-3 text-right text-cyan-400">
                  {summaryMetrics.avgMethane.toFixed(2)}
                </td>
                <td className="px-2.5 py-3 text-right text-slate-400">-</td>
                <td className="px-2.5 py-3 text-right text-slate-400">-</td>
                <td className="px-2.5 py-3 text-right text-slate-400">-</td>
                <td className="px-2.5 py-3 text-right text-slate-400">-</td>
                <td className="px-2.5 py-3 text-right text-slate-400">-</td>
                <td className="px-2.5 py-3 text-right text-slate-400 border-r border-slate-800">-</td>

                {/* Heavy Trace Placeholders */}
                {showHeavyTrace && (
                  <td colSpan={9} className="px-2 py-3 text-center text-[10px] text-slate-500 font-normal">
